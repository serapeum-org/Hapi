...
# The optimiser hands back a flat vector; the model holds a checked `ParameterSet`,
# whose width rule comes from the same (snow, maxbas) pair the bounds were read with.
