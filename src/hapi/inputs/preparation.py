"""Getting rasters ready for a run: alignment to a DEM, and the global parameter sets.

Unlike the rest of this package, nothing here is held by a model. These are the utilities
that produce the files a model is then built from.
"""
